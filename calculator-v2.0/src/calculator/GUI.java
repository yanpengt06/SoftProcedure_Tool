...
public class GUI {
    ...
    public GUI(){
        ...
        for(int i = 0;i < 5;i++)
        {
            ...
            ImageIcon icon = new ImageIcon("./src/calculator/qst.png");//  图片地址,相对寻址
            icon.setImage(icon.getImage().getScaledInstance(50, 50,Image.SCALE_DEFAULT ));		//设定一个小icon
        ...
        JBStart.addActionListener(
                new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        if(JBStart.getText().equals("开始做题"))		//还未出题
                        {
    ...
    public void printAnswer()
    {
        ...
        for(int i = 0; i < 5;i++)
        {
            ...
            //否则用用户填的余数给余数数组赋值
            userRemainder[i] = Integer.valueOf(JTFRemainder[i].getText());
